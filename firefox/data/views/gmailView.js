...
Gmail2Trello.GmailView = function () {
...
Gmail2Trello.GmailView.prototype.detectSplitLayoutMode = function () {
    var self = this;
    ...
    if ($activeGroup.find(".apv").length > 0) {
        ...
        //bind events
        var counter = 0;
        $(".BltHke .apv:not([g2t_event])").each(function () {
            counter++;
            $(this)
                .attr("g2t_event", 1)
                .click(function () {
...
Gmail2Trello.GmailView.prototype.detectEmailOpenningMode = function () {
    var self = this;
...
Gmail2Trello.GmailView.prototype.parseData = function () {
    ...
    else $viewport = jQuery(this.selectors.viewport, this.$root);
    log($viewport);
