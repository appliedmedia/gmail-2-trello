...
function runPerformanceTest() {
  ...
  console.log(`Events per second: ${(iterations / (avgTime / 1000)).toLocaleString()}`);
...
console.log('\n🎯 Analysis:');
console.log(`The custom EventTarget implementation can handle ${(results.average / 1000).toFixed(2)} million events per second.`);
...
console.log(`Memory increase for 1000 listeners: ${(memoryIncrease / 1024).toFixed(2)} KB`);
console.log(`Average memory per listener: ${(memoryIncrease / 1000).toFixed(2)} bytes`);