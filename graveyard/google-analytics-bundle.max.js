(function() {
    ...
    var ia = String.prototype.trim ? function(a) {
        ...
        ja = String.prototype.repeat ? function(a, b) {
            return a.repeat(b)
        } : function(a, b) {
    ...
    var ua = "StopIteration" in k ? k.StopIteration : {
    ...
    z.prototype.remove = function(a) {
        return A(this.B, a) ? (delete this.B[a], this.g--, this.Qa++, this.b.length > 2 * this.g && Da(this), !0) : !1
    };
    var Da = function(a) {
        if (a.g != a.b.length) {
    ...
    h.Yb = function(a) {
        ...
        var b = 0,
            ...
            e = new va;
        e.next = function() {
            if (c != d.Qa) throw Error("The map has changed since the iterator was created");
    ...
    h.qa = function() {
        ...
        if (!r(this.h)) throw Error("Must specify a delegate filter using #applyFilter.");
        return t(function(a) {
    ...
    var Ta = function(a, b) {
        if (null != a.Ga) throw Error("LabelerBuilder: Only one labeling strategy may be used.");
        a.Ga = t(function(a) {
            var d = a.ba().get(Ma),
                e = a.ba().get(La);
            ea(d) && (d = b(d), null != e && this.rb && (d = e + this.Fb + d), a.ba().set(La, d))
        }, a);
        return a
    };
    C.prototype.qa = function() {
        ...
        return Sa().Wb("event").sb(t(function(a) {
            this.Ga(a);
    ...
    var Ua = function(a, b) {
            ...
            return d.replace(/%([0\-\ \+]*)(\d+)?(\.(\d+))?([%sfdiu])/g, function(a, b, d, l, x, M, V, W) {
                if ("%" == M) return "%";
                var Pb = c.shift();
                if ("undefined" == typeof Pb) throw Error("[goog.string.format] Not enough arguments");
                arguments[0] = Pb;
        ...
        D = {
            s: function(a, b, c) {
                return isNaN(c) || "" == c || a.length >= Number(c) ? a : a = -1 < b.indexOf("-",
                    0) ? a + ja(" ", Number(c) - a.length) : ja(" ", Number(c) - a.length) + a
            },
            f: function(a, b, c, d, e) {
                ...
                return d = 0 <= b.indexOf("-", 0) ? f + d + ja(" ", a) : f + ja(0 <= b.indexOf("0", 0) ? "0" : " ", a) + d
            },
            d: function(a, b, c, d, e, f, g, l) {
                return D.f(parseInt(a,
                    10), b, c, d, 0, f, g, l)
            }
        };
    D.i = D.d;
    ...
    var Va = function(a) {
        ...
        Wa = function(a, b) {
            if (a.forEach && "function" == typeof a.forEach) a.forEach(b, void 0);
                ...
                for (var d = Va(a), e = d.length, f = 0; f < e; f++) b.call(void 0,
                    d[f], c && c[f], a)
            }
        };
    var E = function(a) {
    ...
    h.U = function(a) {
        null != this.P && null != this.X && !a.H.$(this.P.name) && a.set(this.P, this.X);
        r(this.h) && this.h(a)
    };
    var Ya = new F(ba);
    var G = function() {
    ...
    var bb = J("Opera") || J("OPR"),
        K = J("Trident") || J("MSIE"),
        cb = J("Edge"),
        db = J("Gecko") && !(-1 != I.toLowerCase().indexOf("webkit") && !J("Edge")) && !(J("Trident") || J("MSIE")) && !J("Edge"),
    ...
    var kb = gb,
        ...
        L = function(a) {
            ...
            if (!(b = lb[a])) {
                b = 0;
                for (var c = ia(String(kb)).split("."), d = ia(String(a)).split("."), e = Math.max(c.length, d.length), f = 0; 0 == b && f < e; f++) {
                    var g = c[f] || "",
                        l = d[f] || "",
                        x = /(\d*)(\D*)/g,
                        M = /(\d*)(\D*)/g;
                    do {
                        ...
                        b = ka(0 == V[1].length ? 0 : parseInt(V[1], 10), 0 == W[1].length ? 0 : parseInt(W[1], 10)) || ka(0 == V[2].length, 0 == W[2].length) || ka(V[2], W[2])
                    } while (0 == b)
                }
                b = lb[a] = 0 <= b
            }
        ...
        mb = k.document,
        nb = mb &&
        K ? fb() || ("CSS1Compat" == mb.compatMode ? parseInt(kb, 10) : 5) : void 0;
    var ob = !K || 9 <= Number(nb),
        pb = K && !L("9"),
        qb = !eb || L("528"),
        rb = db && L("1.9b") || K && L("8") || bb && L("9.5") || eb && L("528"),
        sb = db && !L("8") || K && !L("9");
    var tb = function(a, b) {
        ...
        if (a) {
            ...
            null === d ? (this.offsetX = eb || void 0 !== a.offsetX ? a.offsetX : a.layerX, this.offsetY = eb || void 0 !== a.offsetY ? a.offsetY : a.layerY, this.clientX = void 0 !== a.clientX ? a.clientX : a.pageX, this.clientY = void 0 !== a.clientY ? a.clientY : a.pageY, this.screenX = a.screenX || 0, this.screenY = a.screenY || 0) : (this.clientX = void 0 !== d.clientX ? d.clientX : d.pageX, this.clientY = void 0 !== d.clientY ? d.clientY : d.pageY, this.screenX = d.screenX ||
    ...
    N.prototype.add = function(a, b, c, d, e) {
        ...
        var g = zb(a, b, d, e); - 1 < g ? (b = a[g], c || (b.ra = !1)) : (b = new xb(b, this.src, f, !!d, e), b.ra = c, a.push(b));
        return b
    };
    ...
    var Ab = function(a, b) {
        var c = b.type;
        c in a.m && ra(a.m[c], b) && (yb(b), 0 == a.m[c].length && (delete a.m[c], a.na--))
    };
    ...
    var Bb = "closure_lm_" + (1E6 * Math.random() | 0),
        ...
        Mb = function(a, b, c, d, e) {
            ...
            else c = Fb(c), vb(a) ? a.pb(b, c, d, e) : a && (a = Hb(a)) && (b = a.ja(b, c, !!d, e)) && Nb(b)
        },
        Nb = function(a) {
            if (!ea(a) && a && !a.removed) {
                var b = a.src;
                if (vb(b)) Ab(b.J, a);
                    ...
                    var c = a.type,
                        d = a.proxy;
                    b.removeEventListener ? b.removeEventListener(c, d, a.sa) : b.detachEvent && b.detachEvent(Jb(c), d);
                    Db--;
                    (c = Hb(b)) ? (Ab(c, a), 0 == c.na && (c.src = null, b[Bb] = null)) : yb(a)
                }
            }
        },
        Jb = function(a) {
            ...
            if (a = Hb(a))
                if (b = a.m[b.toString()])
                    for (b = b.concat(), a = 0; a < b.length; a++) {
                        var f = b[a];
                        f && f.sa == c && !f.removed && (f = Ob(f, d), e = e && !1 !== f)
                    }
            return e
        },
        Ob = function(a, b) {
        ...
        Kb = function(a, b) {
            ...
            if (!ob) {
                ...
                if (!(0 > e.keyCode || void 0 != e.returnValue)) {
                    ...
                    for (g = 0; !c.ea &&
                        g < e.length; g++) c.currentTarget = e[g],
                    l = Qb(e[g], f, !1, c),
                    d = d && l
                }
                return d
    ...
    h.dispatchEvent = function(a) {
        ...
        var e = !0,
            f;
        if (b)
            for (var g = b.length - 1; !a.ea && 0 <= g; g--) f = a.currentTarget = b[g], e = Sb(f, d, !0, a) && e;
        a.ea || (f = a.currentTarget = c, e = Sb(f, d, !0, a) && e, a.ea || (e = Sb(f, d, !1, a) && e));
        if (b)
            for (g = 0; !a.ea && g < b.length; g++) f = a.currentTarget = b[g], e = Sb(f, d, !1, a) && e;
        return e
    };
    h.A = function() {
        O.W.A.call(this);
    ...
    Tb.prototype.get = function() {
        var a;
        0 < this.Ja ? (this.Ja--, a = this.Ba, this.Ba = a.next, a.next = null) : a = this.kc();
        return a
    };
    ...
    Xb.prototype.remove = function() {
        var a = null;
        this.ga && (a = this.ga, this.ga = this.ga.next, this.ga || (this.Ra = null), a.next = null);
        return a
    };
    var Yb = function() {
    ...
    var dc = function(a, b) {
        ...
        $b, ac = function() {
            if (k.Promise && k.Promise.resolve) {
                ...
                var a = ec;
                !q(k.setImmediate) || k.Window && k.Window.prototype && !J("Edge") && k.Window.prototype.setImmediate == k.setImmediate ? (Vb || (Vb = Wb()), Vb(a)) : k.setImmediate(a)
            }
        },
        bc = !1,
        cc = new Xb,
    ...
    var nc = function(a, b) {
            if (0 == a.C)
                if (a.o) {
                    var c = a.o;
                    if (c.O) {
                        for (var d = 0, e = null, f = null, g = c.O; g && (g.pa || (d++, g.T == a && (e = g), !(e && 1 < d))); g = g.next) e || (f = g);
                        e && (0 == c.C && 1 == d ? nc(c, b) : (f ? (d = f, d.next == c.Z && (c.Z = d), d.next = d.next.next) : oc(c), pc(c, e, 3, b)))
                    }
                    a.o = null
                } else hc(a, 3, b)
        },
            ...
            if (0 == a.C) {
                ...
                a: {
                    var e = c,
                        f = a.ed,
                        g = a.fd;
                    if (e instanceof P) rc(e, kc(f || ba, g || null, a)),
                    d = !0;
                    else if (gc(e)) e.then(f, g, a),
                    d = !0;
                    else {
                        if (r(e)) try {
                            var l = e.then;
                ...
                d || (a.M = c, a.C = b, a.o = null, qc(a), 3 != b || c instanceof mc || tc(a, c))
            }
        },
    ...
    */
        ...
        yc = function(a) {
            ...
            for (var b = a.M, d = c = !1; a.Ma.length && !a.Ua;) {
                ...
                if (f = a.ka ? g : f) try {
                    ...
                    m(l) && (a.ka = a.ka && (l == b || l instanceof Error), a.M = b = l);
                    if (gc(b) || "function" === typeof k.Promise && b instanceof k.Promise) d = !0, a.Ua = !0
                } catch (x) {
                    b =
                        x, a.ka = !0, Dc(a) || (c = !0)
                }
            ...
            a.M = b;
            d && (l = t(a.wb, a, !0), d = t(a.wb, a, !1), b instanceof Q ? (Bc(b, l, d), b.dc = !0) : b.then(l, d));
    ...
    h.send = function(a, b) {
        ...
        var c = this.Mb.clone();
        b instanceof E ? c.addAll(b) : r(b) && wa(b, function(a, b) {
            null != a && c.set($c(b), a)
        }, this);
    ...
    var cd = function(a, b, c, d, e, f) {
        ...
        this.pc = !!c;
        this.jc = !!d;
        for (b = this.Hb = 0; b < a.length; b++) Bc(a[b], t(this.Bb, this, b, !0), t(this.Bb, this, b, !1));
    ...
    cd.prototype.Bb = function(a, b, c) {
        this.Hb++;
        this.Za[a] = [b, c];
        this.K || (this.zb && b ? this.G([a, c]) : this.pc && !b ? this.I(c) : this.Hb == this.ib.length && this.G(this.Za));
        this.jc && !b && (c = null);
        return c
    };
    ...
    var U = function(a) {
        if (!Cc(a.ma).K) throw Error("Settings object accessed prior to entering ready state.");
    };
    var od = function() {
        O.call(this);
    ...
    od.prototype.get = function(a) {
        ...
        this.R.get(c, function(a) {
            chrome.runtime.lastError ? b.I(chrome.runtime.lastError) : (a = a[c], b.G(null != a ? a.toString() : void 0))
        });
        return b
    };
    ...
    h.bd = function() {
        if (this.enabled) {
            var a = u() - this.hb;
            0 < a && a < .8 * this.Ea ? this.l = this.fa.setTimeout(this.Va, this.Ea - a) : (this.l && (this.fa.clearTimeout(this.l), this.l = null), this.dispatchEvent("tick"), this.enabled && (this.l = this.fa.setTimeout(this.Va, this.Ea), this.hb = u()))
        }
    };
    h.start = function() {
        this.enabled = !0;
    ...
    var yd = function(a, b, c, d, e, f) {
        if (n(c))
            for (var g = 0; g < c.length; g++) yd(a, b, c[g], d, e, f);
        else {
    ...
    Y.prototype.pb = function(a, b, c, d, e) {
        ...
        else c = c || this.handleEvent, e = e || this.eb || this, c = Fb(c), d = !!d, b = vb(a) ? a.ja(b, c, d, e) : a ? (a = Hb(a)) ? a.ja(b, c, d, e) : null : null, b && (Nb(b), delete this.b[b.key]);
        return this
    };
    Y.prototype.removeAll = function() {
        wa(this.b, function(a, b) {
    ...
    var zd = function() {
        O.call(this);
        this.wa = new Y(this);
        qb && (rb ? this.wa.listen(sb ? document.body : window, ["online", "offline"], this.Cb) : (this.Lb = qb ? navigator.onLine : !0, this.l = new vd(250), this.wa.listen(this.l, "tick", this.vc), this.l.start()))
    };
    w(zd, O);
    ...
    Jd.prototype.send = function(a, b) {
        var c = b.get(Qc),
            ...
            d;
        "timing" != a ? d = nd(this.j) : ((d = b.get(Tc)) && b.remove(Tc), d = d || nd(this.j));
    ...
    var Od = function(a) {
        var b;
        (b = a.tb) || (b = {}, Nd(a) && (b[0] = !0, b[1] = !0), b = a.tb = b);
        return b
    };
    var Pd, Qd = function() {};
    w(Qd, Md);
    var Rd = function(a) {
        ...
        Nd = function(a) {
            if (!a.Db && "undefined" == typeof XMLHttpRequest && "undefined" != typeof ActiveXObject) {
    ...
    Z.prototype.send = function(a, b, c, d) {
        if (this.a) throw Error("[goog.net.XhrIo] Object is active with another request=" + this.gb + "; newUri=" + a);
        ...
        this.Lc && "onprogress" in this.a && (this.a.onprogress = t(function(a) {
            this.Jb(a, !0)
        }, this), this.a.upload && (this.a.upload.onprogress = t(this.Jb, this)));
        try {
            this.fb = !0, this.a.open(b, String(a),
                !0), this.fb = !1
        } catch (f) {
            this.va(5, f);
            return
        ...
        !(0 <= la(Td, b)) || d || c || e.set("Content-Type", "application/x-www-form-urlencoded;charset=utf-8");
        ...
        try {
            Wd(this), 0 < this.Oa && ((this.qb = Xd(this.a)) ? (this.a.timeout = this.Oa, this.a.ontimeout = t(this.Tb, this)) :
                this.Na = wd(this.Tb, this.Oa, this)), this.Da = !0, this.a.send(a), this.Da = !1
        } catch (f) {
            this.va(5, f)
        }
    };
    ...
    Z.prototype.Tb = function() {
        "undefined" != typeof aa && this.a && (this.Ha = "Timed out after " + this.Oa + "ms, aborting", this.dispatchEvent("timeout"), this.abort(8))
    };
    ...
    Z.prototype.abort = function() {
        this.a && this.N && (this.N = !1, this.V = !0, this.a.abort(), this.V = !1, this.dispatchEvent("complete"), this.dispatchEvent("abort"), Zd(this))
    };
    Z.prototype.A = function() {
        this.a && (this.N && (this.N = !1, this.V = !0, this.a.abort(), this.V = !1), Zd(this, !0));
        Z.W.A.call(this)
    };
    ...
    var $d = function(a) {
        if (a.N && "undefined" != typeof aa && (!a.Sa[1] || 4 != ae(a) || 2 != be(a)))
            ...
            try {
                ...
                if (!(d = c)) {
                    ...
                    if (e = 0 === b) {
                        ...
                        if (!f && k.self && k.self.location) var g = k.self.location.protocol,
    ...
    var de = function(a, b, c) {
        ...
        ee = function(a) {
            a.c || (a.c = new z, a.g = 0, a.F && Ld(a.F, function(b, c) {
    ...
    h.remove = function(a) {
        ee(this);
        a = fe(this, a);
        return this.c.$(a) ? (this.F = null, this.g -= this.c.get(a).length, this.c.remove(a)) : !1
    };
    h.$ = function(a) {
        ee(this);
        a = fe(this, a);
    ...
    ge.prototype.send = function(a, b) {
        ...
        var c = new Q,
            d = he(a, b);
        d.length > this.Ia ? c.I({
            status: "payload-too-big",
            ta: Ua("Encoded hit length == %s, but should be <= %s.", d.length, this.Ia)
        }) : Vd(this.Uc, function() {
            c.G(Gd)
        }, d);
        return c
    ...
    ie.prototype.cb = function() {
        if (!this.D) {
            if (!Cc(this.j.ma).K) throw Error("Cannot construct shared channel prior to settings being ready.");
            new zd;
    ...
    v("analytics.getService", function(a, b) {
        ...
        if (null === c) {
            ...
            if (!Fa) {
                var e = ke();
                Fa = new ud(e, new ie(e, "https://www.google-analytics.com/collect", 8192))
            }
    ...
    v("analytics.internal.GoogleAnalyticsService.prototype.getTracker", bd.prototype.tc);
    v("analytics.internal.GoogleAnalyticsService.prototype.getConfig", bd.prototype.rc);
    v("analytics.internal.ServiceSettings", T);
    v("analytics.internal.ServiceSettings.prototype.setTrackingPermitted", T.prototype.Wc);
    v("analytics.internal.ServiceSettings.prototype.isTrackingPermitted", T.prototype.Fa);
    v("analytics.internal.ServiceSettings.prototype.setSampleRate", T.prototype.Vc);
    ...
    v("analytics.internal.ServiceTracker.Timing.prototype.send", ad.prototype.send);
    v("analytics.internal.ServiceTracker.prototype.forceSessionStart", S.prototype.qc);
    ...
    v("analytics.internal.FilterChannel.Hit.prototype.getParameters", R.prototype.ba);
    ...
    v("analytics.filters.EventLabelerBuilder.prototype.appendToExistingLabel", C.prototype.cc);
    v("analytics.filters.EventLabelerBuilder.prototype.stripValue", C.prototype.$c);
    v("analytics.filters.EventLabelerBuilder.prototype.powersOfTwo", C.prototype.Kc);
    v("analytics.filters.EventLabelerBuilder.prototype.rangeBounds", C.prototype.Mc);
